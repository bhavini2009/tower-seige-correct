...
function setup(){
    ...
    Connection = new Shot(this.Ball,{x:200,y:200});
}
function draw(){
    ...
    imageMode(CENTER);
    image(polygonImg,Ball.position.x,Ball.position.y,70,45);

    GROUND.display();

    textSize(20)
    text("Drag the Polygon and release it, to launch it towards the blocks",20,20);
}
